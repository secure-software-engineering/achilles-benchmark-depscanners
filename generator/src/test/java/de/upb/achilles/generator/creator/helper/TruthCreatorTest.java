...
public class TruthCreatorTest {
  ...
  public void createTruthAsString() throws JsonProcessingException {
    ...
    TruthCreator truthCreatorTest =
        new TruthCreator(projectGAV, testFixtureModels, Paths.get(System.getProperty("user.home")));
    ...
    for (TestFixtureModel model : testFixtureModels) {
      ...
      String truthString =
          truthCreatorTest.createTestFixturesTruths(Collections.singletonList(model));
      assertNotEquals("", truthAsString);
